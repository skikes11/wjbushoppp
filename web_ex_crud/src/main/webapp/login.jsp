...
<div class="box-form">
 ...
 <h2> Login  </h2>
     ...
     <td>
   <div class="input-box">  <input type="text" name="username" value="skikes11" > </div>
     </td>  
    </tr>
    <tr>
     ...
     <td>
     <div class="input-box">
     <input type="password"  name="password"  value="123456bo" >
     </div>
     </td>
    </tr>
   </table>
   	...
   	&nbsp;&nbsp;&nbsp;&nbsp;
   	<a href="registerPage" class="btn-ss"> Sign Up </a>
   	</div>
   </form>
   </div>
   </section>
