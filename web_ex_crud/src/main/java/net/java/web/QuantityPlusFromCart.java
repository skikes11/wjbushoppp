...
/**
 * Servlet implementation class QuantityPlusFromCart
 */
@WebServlet("/QuantityPlusFromCart")
public class QuantityPlusFromCart extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuantityPlusFromCart() {
        super();
